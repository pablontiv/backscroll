...
├── patterns.go        — patterns command (v2: --kind commands|failures|templates|sequences|corrections [--pending] [--batch N], --project, --tag, --min-support, --min-confidence, --min-length, --max-length, --json, --robot)
