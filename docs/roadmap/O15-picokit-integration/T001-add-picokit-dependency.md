...
- INV1: `go build ./...` pasa tras agregar la dependencia.
  - Verificar: `go build ./...` desde `/home/shared/harness/backscroll`.
...
**In**:
1. `go get github.com/pablontiv/picokit@v0.1.1` desde `/home/shared/harness/backscroll`.
2. `go mod tidy`.
...
- `grep picokit /home/shared/harness/backscroll/go.mod` retorna vacío.
- picokit v0.1.1 resuelve vía `go get`.

## Criterios de Aceptación

- `grep "pablontiv/picokit" /home/shared/harness/backscroll/go.mod` muestra `v0.1.1` o superior.
- `go build ./...` pasa.
