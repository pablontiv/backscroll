...
> **Status: COMPLETED** (2026-03-26) — All 7 tasks executed, 41/41 tests passing, CI green, release published.
...
- [x]**Step 1: Add the [lib] and [[bin]] sections to Cargo.toml**
...
- [x]**Step 2: Verify Cargo.toml parses correctly**
...
- [x]**Step 2: Verify it compiles (expect errors in main.rs)**
...
- [x]**Step 1: Replace module declarations (lines 3-6)**
...
- [x]**Step 2: Update the import block (lines 8-16)**
...
- [x]**Step 3: Update the inline crate::core reference on line 462**
...
- [x]**Step 4: Verify main.rs compiles**
...
- [x]**Step 1: Change the import on line 1**
...
- [x]**Step 2: Verify everything compiles clean**
...
- [x]**Step 1: Write the library API integration test**
...
- [x]**Step 3: Run the full test suite to ensure no regressions**
...
- [x]**Step 1: Generate library documentation**
...
- [x]**Step 2: Run the full check suite (equivalent of `just check`)**

Run: `cd /opt/backscroll && cargo fmt --check && cargo clippy -- -D warnings && cargo check 2>&1`

Expected: All clean.

- [x]**Step 3: Build release binary and verify it works**
...
- [x]**Step 4: Run just test as final confirmation**
