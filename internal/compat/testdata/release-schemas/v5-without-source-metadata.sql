-- Backscroll release schema fixture: v5-without-source-metadata.sql
-- Hermetic schema-only fixture captured for compatibility tests.
-- No manifest release tag maps to this fixture.
-- It preserves a partially migrated V5 shape for compatibility triangulation
-- only: session_events and source_metadata are absent together without claiming
-- a published release in the manifest shipped this exact shape.
