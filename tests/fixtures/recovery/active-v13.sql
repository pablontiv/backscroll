...
INSERT INTO indexed_files (path, hash, last_indexed) VALUES ('/fixtures/recovery/active-v13.jsonl', 'hash-active-v13', '2026-08-18T00:00:00Z');
INSERT INTO indexed_files (path, hash, last_indexed) VALUES ('/fixtures/recovery/active-v13-defaults.jsonl', 'hash-active-v13-defaults', '2026-08-18T00:00:01Z');
INSERT INTO search_items (source, source_path, ordinal, role, text, timestamp, uuid, project, content_type)
VALUES ('source-active-v13', '/fixtures/recovery/active-v13.jsonl', 41, 'assistant', 'text sentinel for active-v13', '2026-08-18T12:34:56Z', 'uuid-active-v13', 'project-active-v13', 'content/active-v13');
INSERT INTO search_items (source, source_path, ordinal, role, text)
VALUES ('session', '/fixtures/recovery/active-v13-defaults.jsonl', 42, 'user', 'default sentinel for active-v13');
COMMIT;
