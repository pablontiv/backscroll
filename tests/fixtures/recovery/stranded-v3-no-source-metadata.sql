-- Backscroll release schema fixture: v3-no-source-metadata.sql
-- Hermetic schema-only fixture captured for compatibility tests.
-- No manifest release tag maps to this fixture.
-- It preserves a partially migrated V3 shape for compatibility triangulation
-- only: source_metadata is absent from search_items even though no published
-- release in the manifest shipped this exact schema_migrations lineage.
...
-- Recovery adapter payload sentinels.
INSERT INTO indexed_files (path, hash, last_indexed) VALUES ('/fixtures/recovery/stranded-v3-no-source-metadata.jsonl', 'hash-stranded-v3-no-source-metadata', '2026-08-18T00:00:00Z');
INSERT INTO indexed_files (path, hash, last_indexed) VALUES ('/fixtures/recovery/stranded-v3-no-source-metadata-defaults.jsonl', 'hash-stranded-v3-no-source-metadata-defaults', '2026-08-18T00:00:01Z');
INSERT INTO search_items (source, source_path, ordinal, role, text, timestamp, uuid, project, content_type)
VALUES ('source-stranded-v3-no-source-metadata', '/fixtures/recovery/stranded-v3-no-source-metadata.jsonl', 41, 'assistant', 'text sentinel for stranded-v3-no-source-metadata', '2026-08-18T12:34:56Z', 'uuid-stranded-v3-no-source-metadata', 'project-stranded-v3-no-source-metadata', 'content/stranded-v3-no-source-metadata');
INSERT INTO search_items (source, source_path, ordinal, role, text)
VALUES ('session', '/fixtures/recovery/stranded-v3-no-source-metadata-defaults.jsonl', 42, 'user', 'default sentinel for stranded-v3-no-source-metadata');
COMMIT;
