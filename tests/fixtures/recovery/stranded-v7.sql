...
INSERT INTO indexed_files (path, hash, last_indexed) VALUES ('/fixtures/recovery/stranded-v7.jsonl', 'hash-stranded-v7', '2026-08-18T00:00:00Z');
INSERT INTO indexed_files (path, hash, last_indexed) VALUES ('/fixtures/recovery/stranded-v7-defaults.jsonl', 'hash-stranded-v7-defaults', '2026-08-18T00:00:01Z');
INSERT INTO search_items (source, source_path, ordinal, role, text, timestamp, uuid, project, content_type)
VALUES ('source-stranded-v7', '/fixtures/recovery/stranded-v7.jsonl', 41, 'assistant', 'text sentinel for stranded-v7', '2026-08-18T12:34:56Z', 'uuid-stranded-v7', 'project-stranded-v7', 'content/stranded-v7');
INSERT INTO search_items (source, source_path, ordinal, role, text)
VALUES ('session', '/fixtures/recovery/stranded-v7-defaults.jsonl', 42, 'user', 'default sentinel for stranded-v7');
COMMIT;
